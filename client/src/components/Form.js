...
export default function Form() {
    ...
    return (
        ...
        <h1 className='font-bold pb-4 text-xl'>Entries</h1>
        ...
        <form id='form' onSubmit={handleSubmit(onSubmit)}> 
            <div className="grid gap-4">
                ...
                <select className='form-input'{...register('type')} >
                    <option value="Investment" defaultValue placeholder='Investment'>Investment</option>
                    <option value="Expense" placeholder='Expense'>Expense</option>
                    <option value="Savings" placeholder='Savings'>Savings</option>
                </select>
                <div className="input-group">
